      ...
      <div className="mx-auto flex h-16 w-full max-w-5xl items-center justify-between px-5">
        <Link href="/" className="group flex flex-col leading-tight">
          <span className="text-[11px] font-semibold uppercase tracking-[0.14em] text-ff-accent">
            Flinders Fertility · Education
          </span>
          <span className="font-display text-lg text-white group-hover:text-ff-accent-tint">
...
export function SiteFooter() {
  return (
    <footer className="mt-auto border-t border-ff-border bg-ff-card">
      <div className="mx-auto flex max-w-5xl flex-col gap-1 px-5 py-8 text-center text-xs text-ff-muted sm:flex-row sm:justify-between sm:text-left">
        <p>Clinical Rotation in Reproductive Medicine · teaching platform</p>
